...
if [ ! -f "$RESULTS_FILE" ]; then
  echo "timestamp,users_number,run_number,query_name,index_used,planning_time_ms,execution_time_ms,planned_hit,exec_hit,planned_read,exec_read,temp_read,temp_written" > "$RESULTS_FILE"
fi
